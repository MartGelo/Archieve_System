...
public class List extends javax.swing.JInternalFrame {
            ...
            event = new TableActionEvent() {
                ...
                public void onView(int row) {
                    ...
                    try {
                            ...
                            try (ResultSet rs = pstmt.executeQuery()) {
                                if (rs.next()) {
                                    ...
                                    if (pdfBlob != null) {
                                        ...
                                        int userSelection = fileChooser.showSaveDialog(List.this);
                                        if (userSelection == JFileChooser.APPROVE_OPTION) {
                                            ...
                                            try (FileOutputStream fos = new FileOutputStream(filePath)) {
                                                ...
                                                JOptionPane.showMessageDialog(List.this, "PDF file downloaded successfully.");
                                            }
                                        }
                                    } else {
                                        JOptionPane.showMessageDialog(List.this, "PDF file not found for this article.", "Error", JOptionPane.ERROR_MESSAGE);
                                    }
                                }
                            }
                        }
                        ...
                        ex.printStackTrace();
                        JOptionPane.showMessageDialog(List.this, "Error downloading PDF file: " + ex.getMessage(), "Error", JOptionPane.ERROR_MESSAGE);
                    }
                }
    ...
    EditDialog dialog = new EditDialog((Frame) SwingUtilities.getWindowAncestor(List.this), true, (com.mysql.jdbc.Connection) con, originalTitle, email, year, author);
...
private void populateTable() {
    try {
        String query = "SELECT title, email, year_publish, author, pdf_file FROM research_articles"; // Modify this query according to your table structure
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Research Title", "Email", "Year Publish", "Author", "Pdf File", "Action"
            }
        ) {
